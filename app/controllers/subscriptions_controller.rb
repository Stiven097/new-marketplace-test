class SubscriptionsController < ApplicationController
    ...
    def subscribe
        if !current_user.stripe_id?
            return redirect_to edit_payment_path, alert: "Please add a card before subscribing"
        end
        ...
        return redirect_to dashboard_path, notice: "Subscription created successfully"
    end
